class World{
  ...
  public World(){
    ...
    map[BTD.WORLD_HEIGHT-2][BTD.WORLD_WIDTH-2]=new Player(BTD.WORLD_WIDTH-2,BTD.WORLD_HEIGHT-2,100);
      map[BTD.WORLD_HEIGHT-1][BTD.WORLD_WIDTH-1]=new Player(BTD.WORLD_WIDTH-1,BTD.WORLD_HEIGHT-1,100);
      map[BTD.WORLD_HEIGHT-2][BTD.WORLD_WIDTH-1]=new Player(BTD.WORLD_WIDTH-2,BTD.WORLD_HEIGHT-1,100);
      map[BTD.WORLD_HEIGHT-1][BTD.WORLD_WIDTH-2]=new Player(BTD.WORLD_WIDTH-1,BTD.WORLD_HEIGHT-2,100);
